...
scK_error_rho = ScaledKriging(design_space=func._input_domain, rho_optimize=True)
...
scK_error_rho.train(sample_x, sample_y)
...
mf_pre_3, mf_std_3 = scK_error_rho.predict(test_x, return_std=True)
...
print('Pres of multi-fidelity of models: \n', np.concatenate([mf_pre, mf_pre_2, mf_pre_3], axis=1))
print('Std values of pres: \n', np.concatenate([mf_std, mf_std_2, mf_std_3], axis=1))