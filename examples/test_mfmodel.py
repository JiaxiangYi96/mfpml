...
sfK = Kriging(kernel_mode='KRG', n_dim=func.num_dim)
...
ScK = ScaledKriging(kernel_mode='KRG', n_dim=func.num_dim)
...
print('Std values of pres: \n', np.concatenate([sf_std, sf_std_2, mf_std, mf_std_2], axis=1))