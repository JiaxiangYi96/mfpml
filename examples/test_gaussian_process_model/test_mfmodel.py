...
# print(sample_x)
sample_lx = np.linspace(0, 1.0, 11, endpoint=True).reshape(-1, 1)
sample_hx = np.array([0.0, 0.4, 0.6, 1.0]).reshape(-1, 1)
...
# print('test y', test_y)
# pso_opt = PSO(num_gen=300, num_pop=100)
...
mf_pre_2, mf_std_2 = coK.predict(test_x, return_std=True)
# print(mf_std_2)
