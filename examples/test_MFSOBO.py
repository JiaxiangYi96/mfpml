...
from mfpml.models.mf_surrogates import HierarchicalKriging, CoKriging
...
opti.run_optimizer(mf_surrogate=HK, acqusition=acf3, max_iter=20, init_X=sample_x, init_Y=sample_y)
